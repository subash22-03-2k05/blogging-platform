    ...
    <section className="section-padding">
      <div className="container-app">
        <div className="text-center mb-12">
          <h1 className="font-space-grotesk text-h2 font-bold">Blog</h1>
          <p className="text-text-secondary text-body max-w-2xl mx-auto">Latest articles from our community</p>
        </div>
